...
public class WeeklyConfession extends ChurchEvent {

    public WeeklyConfession(Day day) {
        initialize(day);
    }

    public WeeklyConfession(Day day, int hour, int min) {
    ...
    private void initialize(Day day) {
        ...
        this.setEventType(EventType.CONFESSION);
    }
